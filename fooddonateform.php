...
if(isset($_POST['submit']))
{
    ...
    $query="insert into food_donations(email,food,type,category,phoneno,location,address,name,quantity) values('$emailid','$foodname','$meal','$category','$phoneno','$location','$address','$name','$quantity')";
