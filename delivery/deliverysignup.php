      ...
      <form method="post" action=" ">
        ...
        <div class="txt_field">
          ...
          <div class="">
                          ...
                          <option value="Longbeach" selected>Longbeach</option>
                          <!-- <option value="Park Avenue Apartments">Park Avenue Apartmentsr</option>
                          <option value="Beverly plz">Beverly plz</option>
