...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"losangeles\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $losangeles=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"longbeach\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $longbeach=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"norwalk\"";
...
var xplace=["losangeles","longbeach","norwalk"];
var yplace=[<?php echo json_encode($losangeles,JSON_HEX_TAG);?>,<?php echo json_encode($longbeach,JSON_HEX_TAG);?>,<?php echo json_encode($norwalk,JSON_HEX_TAG);?>];
